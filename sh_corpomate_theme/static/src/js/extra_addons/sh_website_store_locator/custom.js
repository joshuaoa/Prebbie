odoo.define('sh_corpomate_theme.sh_website_store_locator_js', function (require) {
    'use strict';
    ...
    publicWidget.registry.CustomJsGoogleMap = publicWidget.Widget.extend({
        ...
        _onClickCurrentLocation: function (ev) {
            ...
            // console.log('\n\n _onClickCurrentLocation',self.initialize_data.map_stores_data)
        },
        ...
        getLocation:  function (stores) {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(async function(position){
                    ...
                    var dist_dic = await ajax.jsonRpc('/store/sh_store_locator/current_location', 'call', {
        ...
        _onClickStoreMoreInfo: function (ev){
            ...
            if(StoreId){
                ajax.jsonRpc("/sh_get_store_details_template", "call", {
                    StoreId: StoreId,
                }).then((data) => {
                    ...
                    if(data && data.stores){
                        var dialog = new Dialog(this, {
                            ...
                            $content: qweb.render('sh_corpomate_theme.StoreMoreDetails', {
                                stores: stores,
                            }),
                            buttons: [
        ...
        hide_marker_and_shop : function(key) {
            ...
            // var ids = document.querySelectorAll('#'+(key +1)+'');
            // console.log('\n\n ids',ids)
        ...
        sh_locator_call_json : function(vals,alert_flag) {
            ...
            ajax.jsonRpc('/store/sh_store_locator/vals', 'call', vals)
                .then(function(data) {
                    if (data) {
