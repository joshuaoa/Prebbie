...
# Part of Softhealer Technologies.
{
    ...
    "data": [
        ...
        "views/snippets/onemate_1_s.xml",
        "views/snippets.xml",
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'sh_corpomate_theme/static/src/scss/extra_addons/onemate/onemate.scss',
            ...
            'sh_corpomate_theme/static/src/js/extra_addons/onemate/swiper_slider.js',
